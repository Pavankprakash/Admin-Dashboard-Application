...
const activities = [
    ...
    },
    {
        ...
        bgColor: 'bg-purpul-100 dark:bg-purpul;-900/30',
    },
    {
        id: 4,
        type: 'system',
...
function Activityfeed() {
    return (
        <div className='bg-white/80 dark:bg-slate-950/80 backdrop-blur-xl rounded-2xl border
    border-slate-200/50 dark:border-slate-700/50'>
            <div className='p-6 border-b border-200/50 dark:border-slate-700/50'>
                <div>
            ...
            <div className='p-6'>
                <div className='space-y-4'>
                    {activities.map((activity, index) => {
                        return (
                            <div key={index} className='flex items-start space-x-4 p-4 rounded-xl hover:bg-slate-50
